...
class DepositOption(models.Model):
    dcls_month =        models.CharField(max_length=30, null=True) # 공시제출월
    fin_co_no =         models.CharField(max_length=30, null=True) # 금융회사코드
    fin_prdt_cd =       models.CharField(max_length=30, null=True) # 금융상품코드
...
class DepositProduct(models.Model):
    dcls_month      = models.CharField(max_length=30, null=True)  # 공시제출월
    fin_co_no       = models.CharField(max_length=30, null=True)  # 금융회사코드
    kor_co_nm       = models.CharField(max_length=30, null=True)  # 금융회사명
    fin_prdt_cd     = models.CharField(max_length=30, null=True)  # 금융상품코드
    fin_prdt_nm     = models.CharField(max_length=30, null=True)  # 금융상품명
    ...
    max_limit       = models.CharField(max_length=30, null=True)  # 최고한도
